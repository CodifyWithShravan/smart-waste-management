...
// Unique ID for this bin — *** THIS IS BIN-003 ***
...
#define LORA_ADDRESS    3             // *** Address 3 for BIN-003 ***
 ...
 *
 * Example:
 *   AT+SEND=0,25,BIN-003,75,17.4215,78.6580
 */
...
void loop() {
  ...
  // --- Build Payload ---
  // Format: BIN-003,75,17.4215,78.6580
  char payload[64];
