...
// Unique ID for this bin — *** THIS IS BIN-002 ***
#define BIN_ID          "BIN-002"
...
#define LORA_ADDRESS    2             // *** Address 2 for BIN-002 ***
 ...
 *
 * Example:
 *   AT+SEND=0,25,BIN-002,75,17.4185,78.6545
 */
...
void loop() {
  ...
  // --- Build Payload ---
  // Format: BIN-002,75,17.4185,78.6545
  char payload[64];
